...
const NAME = 'App-test'; // app name
const EXPO_ACCOUNT_OWNER = 'luankcf5'; // expo account owner
const EAS_PROJECT_ID = '3fc8d881-441a-40f3-9433-fc3276df6d60'; // eas project id
